                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered">
                                ...
                                <?php 
                                    ...
                                    $danh_muc_id = $_GET['DanhMucID'];
                                    $sql = "SELECT * FROM sanpham WHERE DanhMucID = $danh_muc_id";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo ($dong['SL']); ?></td>
                                            <td><?php echo ($dong['GiaGoc']); ?></td>
                                            <td><?php echo ($dong['GiaKM']); ?></td>
                                    ...
                                    <?php 
                                        ...
                                        echo "<tr><td colspan='7'>Không có sản phẩm nào trong danh mục này.</td></tr>";
                                    }
